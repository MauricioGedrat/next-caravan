      ...
      >
        <g>
          ...
          <rect
            ...
            x="46.765"
            y="28.574"
            transform="rotate(45.016 48.095 29.905)"
          />
          <rect
            width="2.661"
            height="2.662"
            x="50.529"
            y="32.338"
            transform="rotate(-45 51.859 33.67)"
          />
          <rect
            width="2.661"
            height="2.662"
            x="54.293"
            y="36.102"
            transform="rotate(-44.992 55.624 37.433)"
          />
          <rect
            width="2.661"
            height="2.661"
            x="58.058"
            y="39.866"
            transform="rotate(-135 59.388 41.196)"
          />
          <rect
            width="46.1"
            height="2.661"
            x="4.688"
            y="49.012"
            transform="rotate(-45 27.737 50.343)"
          />
          <rect
            width="18.619"
            height="2.661"
            x="13.732"
            y="63.744"
            transform="rotate(-45 23.041 65.074)"
          />
          <rect
            width="6.995"
            height="2.661"
            x="29.965"
            y="53.328"
            transform="rotate(135 33.462 54.658)"
          />
          <rect
            width="2.661"
            height="28.389"
            x="32.065"
            y="54.329"
            transform="rotate(-134.992 33.396 68.524)"
          />
          <rect
            width="2.662"
            height="6.995"
            x="39"
            y="44.289"
            transform="rotate(45.008 40.33 47.786)"
          />
          <rect
            width="2.661"
            height="6.996"
            x="45.274"
            y="38.016"
            transform="rotate(-134.992 46.605 41.514)"
          />

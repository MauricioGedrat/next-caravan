...
const ComponentCarousel = () => {
  return (
    <div>
      <Carousel>
        <Carousel.Item>
          <Image src={Img1} alt='carrousel' className="d-block" layout="responsive"/>
        ...
        <Carousel.Item>
          <Image src={Img2} alt='carrousel' layout="responsive"/>
        ...
        <Carousel.Item>
          <Image src={Img3} alt='carrousel' layout="responsive"/>
